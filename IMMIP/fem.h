...
public:
    ...
    double get_local_C(size_t i, size_t j, double t) const;
    double get_local_rp(size_t i, double t) const;
...
public:
    ...
    void input();
    void make_portrait();
    void assembling_global(size_t t);
    void applying_bounds(size_t t);

    double get_solution(const point & p, size_t time_curr) const;
    double get_solution(const point & p, const quadrilateral * fe, size_t time_curr) const;
    point get_grad(const point & p, size_t time_curr) const;
    point get_grad(const point & p, const quadrilateral * fe, size_t time_curr) const;
